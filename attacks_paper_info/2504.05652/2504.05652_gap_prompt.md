...
- Reference implementation files under `attacks_paper_info/2504.05652/` (use them as the gold standard)
- Current generated attack: `src/jbfoundry/attacks/generated/scp_gen.py`

Write/overwrite the file `attacks_paper_info/2504.05652/implementation_gap_notes.md` with markdown that mirrors the style of
...
Rules:
- Do NOT edit any files other than `attacks_paper_info/2504.05652/implementation_gap_notes.md`
